  ...
  var html = '<footer>' +
    ...
    '<div class="footer-bottom">' +
      ...
      '<div class="social-links">' +
        '<a href="https://wingsforscience.blogspot.com/" target="_blank" rel="noopener"><img src="' + p + 'images/wix_import/icon_blogger.png" alt="Blogger"></a>' +
        '<a href="https://www.facebook.com/wingsforscience" target="_blank" rel="noopener"><img src="' + p + 'images/wix_import/icon_facebook.png" alt="Facebook"></a>' +
        '<a href="https://www.youtube.com/playlist?list=PL8A32C328768F858A" target="_blank" rel="noopener"><img src="' + p + 'images/wix_import/icon_youtube.png" alt="YouTube"></a>' +
      '</div>' +
    '</div>' +
  '</footer>';
